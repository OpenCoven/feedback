...
export const segmentCatalog: IntegrationCatalogEntry = {
  ...
  name: 'Segment',
  description:
    'Sync user attributes from Segment into OpenCoven Feedback and push segment membership back.',
  category: 'user_data',
  capabilities: [
    {
      label: 'Inbound attribute sync',
      description:
        'Receive Segment identify events and write user attributes to OpenCoven Feedback automatically',
    },
    {
