 ...
 * Steps an admin tool already filled in via /api/v1/admin/setup
 * are hidden — the user shouldn't see "Step 4 of 4" with three
 * pre-checked boxes for things they didn't do.
 *
